...
- `data-srcset` attribute with setsets generated by Kirbys core `$file->srcset()` method
...
- Where is the picture element support? This plugin v2.x.x versions could do picture element. I removed that and focused on lazyloading to make the plugin simpler again.
